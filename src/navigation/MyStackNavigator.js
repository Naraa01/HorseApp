...
export default () => (
  ...
  >
    <Stack.Screen
      //Screen n uru HomeScreen bolon BookDetail ruu l navigation damjuulnaa,, comp bolh Book.js, Category ntr luu damjuulahgu
      //HomeScreen d navigation bgn bol teriigre HomeScreen ees damjuulj bolno // props oor damjuulaad bh n neg arga
      //2doh arga n useNavigation - ashiglaad shuud ter gazraa ashiglaj bolno, Book.js deer ashiglasan
      name="Home"
